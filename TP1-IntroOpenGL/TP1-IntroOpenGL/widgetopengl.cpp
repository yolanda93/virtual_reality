...
void WidgetOpenGL::initializeVAO()
{
    ...
    m_vao->bind();
        ...
        m_programme->bind();
            ...
            m_programme->setAttributeArray(1, GL_FLOAT, BUFFER_OFFSET(24*sizeof(GLfloat)),3);
...
void WidgetOpenGL::paintGL()
{
    ...
    model = glm::rotate(model, 0.30f, glm::vec3(1.0f, 1.0f, 0.0f));

    m_matrix = proj * vue *glm::rotate(model, m_angleY, glm::vec3(0.0f, 1.0f, 0.0f)) * model ;
